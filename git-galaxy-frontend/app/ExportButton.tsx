        ...
        setTimeout(() => {
            ...
            try {
                ...
                if (ctx) {
                    ...
                    ctx.fillText("Git-Galaxy Explorer", exportCanvas.width - padding, exportCanvas.height - padding - exportCanvas.height * 0.03);

                    ctx.fillStyle = "rgba(255, 136, 0, 0.8)";
                    ctx.font = `${Math.max(16, exportCanvas.height * 0.015)}px monospace`;
                    ctx.fillText("github.com/GitGalaxy", exportCanvas.width - padding, exportCanvas.height - padding);
                ...
                link.download = `gitgalaxy-${username || 'capture'}-${Date.now()}.png`;
                link.href = dataUrl;
                link.click();
