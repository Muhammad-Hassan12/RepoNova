...
export default function RateLimitDashboard({ apiUrl }: RateLimitDashboardProps) {
    ...
    return (
        <div className="absolute bottom-14 sm:bottom-6 left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-6 z-10 pointer-events-auto w-auto sm:w-auto max-w-[200px] sm:max-w-none flex justify-center sm:block bottom-safe-area">
